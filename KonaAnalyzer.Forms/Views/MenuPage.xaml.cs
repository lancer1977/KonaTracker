...
namespace KonaAnalyzer.Views
{
    ...
    public partial class MenuPage : ContentPage
    {
        ...
        public MenuPage()
        {
            ...
            _source.WhenAnyValue(x => x.Loaded).Subscribe(loaded =>
            {
                if (loaded == false) return;
                menuItems.AddRange(_source.States
