...
{
    public class SQLCovidSource_old : BaseSource, ICovidSource
    {
        private readonly ISQLiteFactory _factory;
        private readonly ISettings _settings;

        public SQLCovidSource_old(ILocationSource locationService, ISQLiteFactory factory,ISettings settings)
        {
